...
const Dashboard = () => {
  ...
  const { data: interfaceStats, isLoading: interfaceStatsLoading } =
    useInterfaceStatistics();
  const { data: locationStats, isLoading: locationStatsLoading } =
    useLocationStatistics();
  const { data: maintenanceStats, isLoading: maintenanceStatsLoading } =
    useMaintenanceStatistics();
  ...
  const getStatsForRole = (role) => {
    ...
    const baseStats = {
      ...
      criticalTickets: getPriorityCount(
  ...
  const totalInterfaceCount =
    interfaceStats?.byStatus?.reduce(
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-7">
        ...
        <Card className="col-span-3 border-0 shadow-lg">
          ...
          <CardContent>
            ...
            maintenanceStats.byStatus.length > 0 ? (
              <div className="space-y-4">
                  ...
                  <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-100">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-medium text-blue-900">
                        {maintenanceStats.byPriority.find(
